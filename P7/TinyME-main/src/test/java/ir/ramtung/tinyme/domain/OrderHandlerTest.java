...
public class OrderHandlerTest {
    ...
    void iceberg_order_behaves_normally_before_being_queued() {
        ...
        OrderHandler myOrderHandler = new OrderHandler(securityRepository, brokerRepository, shareholderRepository, mockEventPublisher, new Matcher(), new AuctionMatcher());
