...
public class OrderHandlerTest {
    ...
    void new_order_matched_completely_with_one_trade() {
        Order matchingBuyOrder = new Order(100, security, Side.BUY, 1000, 15500, 0, broker1, shareholder);
        Order incomingSellOrder = new Order(200, security, Side.SELL, 300, 15450, 0, broker2, shareholder);
    ...
    void new_order_matched_partially_with_two_trades() {
        Order matchingBuyOrder1 = new Order(100, security, Side.BUY, 300, 15500, 0, broker1, shareholder);
        Order matchingBuyOrder2 = new Order(110, security, Side.BUY, 300, 15500, 0, broker1, shareholder);
        Order incomingSellOrder = new Order(200, security, Side.SELL, 1000, 15450, 0, broker2, shareholder);
    ...
    void iceberg_order_behaves_normally_before_being_queued() {
        Order matchingBuyOrder = new Order(100, security, Side.BUY, 1000, 15500, 0, broker1, shareholder);
        Order incomingSellOrder = new IcebergOrder(200, security, Side.SELL, 300, 15450, 0, broker2, shareholder, 100);
        security.getOrderBook().enqueue(matchingBuyOrder);
        Trade trade = new Trade(security, matchingBuyOrder.getPrice(), incomingSellOrder.getQuantity(),
                matchingBuyOrder, incomingSellOrder);
    ...
    void update_order_causing_no_trades() {
        Order queuedOrder = new Order(200, security, Side.SELL, 500, 15450, 0, broker1, shareholder);
    ...
    void handle_valid_update_with_trades() {
        Order matchingOrder = new Order(1, security, Side.BUY, 500, 15450, 0, broker1, shareholder);
        Order beforeUpdate = new Order(200, security, Side.SELL, 1000, 15455, 0, broker2, shareholder);
        Order afterUpdate = new Order(200, security, Side.SELL, 500, 15450, 0, broker2, shareholder);
    ...
    void delete_buy_order_deletes_successfully_and_increases_credit() {
        ...
        Order someOrder = new Order(100, security, Side.BUY, 300, 15500, 0, buyBroker, shareholder);
        Order queuedOrder = new Order(200, security, Side.BUY, 1000, 15500, 0, buyBroker, shareholder);
    ...
    void delete_sell_order_deletes_successfully_and_does_not_change_credit() {
        ...
        Order someOrder = new Order(100, security, Side.SELL, 300, 15500, 0, sellBroker, shareholder);
        Order queuedOrder = new Order(200, security, Side.SELL, 1000, 15500, 0, sellBroker, shareholder);
        security.getOrderBook().enqueue(someOrder);
        security.getOrderBook().enqueue(queuedOrder);
    ...
    void invalid_delete_order_with_non_existing_security() {
        Order queuedOrder = new Order(200, security, Side.BUY, 1000, 15500, 0, broker1, shareholder);
        security.getOrderBook().enqueue(queuedOrder);
    ...
    void credit_updated_on_new_order_matched_partially_with_two_orders() {
        ...
        Order matchingSellOrder1 = new Order(100, security, Side.SELL, 30, 500, 0, broker1, shareholder);
        Order matchingSellOrder2 = new Order(110, security, Side.SELL, 20, 500, 0, broker2, shareholder);
    ...
    void new_order_from_buyer_with_enough_credit_based_on_trades() {
        ...
        Order matchingSellOrder1 = new Order(100, security, Side.SELL, 30, 500, 0, broker1, shareholder);
        Order matchingSellOrder2 = new Order(110, security, Side.SELL, 20, 500, 0, broker2, shareholder);
        Order incomingBuyOrder = new Order(200, security, Side.BUY, 100, 550, 0, broker3, shareholder);
        security.getOrderBook().enqueue(matchingSellOrder1);
        security.getOrderBook().enqueue(matchingSellOrder2);
    ...
    void update_buy_order_changing_price_with_no_trades_changes_buyers_credit() {
        Broker broker1 = Broker.builder().brokerId(1).credit(100_000).build();
        brokerRepository.addBroker(broker1);
        Order order = new Order(100, security, Side.BUY, 30, 500, 0, broker1, shareholder);
    ...
    void update_sell_order_changing_price_with_no_trades_does_not_changes_sellers_credit() {
        Broker broker1 = Broker.builder().brokerId(1).credit(100_000).build();
        brokerRepository.addBroker(broker1);
        Order order = new Order(100, security, Side.SELL, 30, 500, 0, broker1, shareholder);
        security.getOrderBook().enqueue(order);
    ...
    void update_order_changing_price_with_trades_changes_buyers_and_sellers_credit() {
        ...
        List<Order> orders = Arrays.asList(
                new Order(1, security, Side.BUY, 304, 570, 0, broker3, shareholder),
                new Order(2, security, Side.BUY, 430, 550, 0, broker3, shareholder),
                new Order(3, security, Side.BUY, 445, 545, 0, broker3, shareholder),
                new Order(6, security, Side.SELL, 350, 580, 0, broker1, shareholder),
                new Order(7, security, Side.SELL, 100, 581, 0, broker2, shareholder)
        );
    ...
    void update_sell_order_with_enough_positions_is_executed() {
        ...
        List<Order> orders = Arrays.asList(
                new Order(1, security, Side.BUY, 304, 570, 0, broker3, shareholder1),
                new Order(2, security, Side.BUY, 430, 550, 0, broker3, shareholder1),
                new Order(3, security, Side.BUY, 445, 545, 0, broker3, shareholder1),
                new Order(6, security, Side.SELL, 350, 580, 0, broker1, shareholder),
                new Order(7, security, Side.SELL, 100, 581, 0, broker2, shareholder)
        );
        orders.forEach(order -> security.getOrderBook().enqueue(order));
