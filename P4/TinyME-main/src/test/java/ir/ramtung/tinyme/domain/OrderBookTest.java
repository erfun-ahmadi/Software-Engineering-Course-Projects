...
class OrderBookTest {
    ...
    void setupOrderBook() {
        ...
        orders = Arrays.asList(
                new Order(1, security, Side.BUY, 304, 15700, 0, broker, shareholder),
                new Order(2, security, Side.BUY, 43, 15500, 0, broker, shareholder),
                new Order(3, security, Side.BUY, 445, 15450, 0, broker, shareholder),
                new Order(4, security, Side.BUY, 526, 15450, 0, broker, shareholder),
                new Order(5, security, Side.BUY, 1000, 15400, 0, broker, shareholder),
